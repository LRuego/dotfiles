...
# Custom aliases
alias ls='eza --icons --header --color=always'
alias cd='z'
...
_FZF_COMMAND='fd --type f --hidden --exclude .git --exclude node_modules --exclude vendor --exclude .wine --exclude .steam'
export FZF_CTRL_T_COMMAND="$_FZF_COMMAND"
export FZF_DEFAULT_COMMAND="$_FZF_COMMAND"
eval "$(fzf --zsh)"
